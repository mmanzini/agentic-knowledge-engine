# Intelligence — wiki index

The wiki has two top-level groupings: **buckets** (user-curated) and
the **`_unsorted/`** quarantine. The agent never invents a bucket;
new buckets are a human decision.
